...
## 3.2.0 Loginom 7.3.1^ (Актуальная версия)

### **Изменения**

* Компонент **[Генератор календаря](./docs/calendar-generator.md)**
* Компонент **[Разность дат](./docs/dates-difference.md)**
* Удален компонент **JSON-парсер JS**

## 3.1.6 Loginom 7.2.4^

### **Новый функционал**

* Компонент **[Декомпозиция (аддитивная)](./docs/decomposition-time-series.md)**
* Компонент **[Декомпозиция (мультипликативная)](./docs/decomposition-time-series.md)**

## v3.1.5 Loginom 7.2.3^

### **Новый функционал**

* Компонент [Разворот иерархии JS](./docs/hierarchy-unfolding.md)

### **Изменения**

* Компонент **[Разность дат](./docs/dates-difference.md)**
* Компонент **[Редкие значения](./docs/random-category.md)**
* Удален компонент **Генератор пустых полей**
...
* Компонент **[Переменные в словарь JS](./docs/vars-to-dict.md)**
...
* Компонент **[Формула Хаверсина](./docs/haversine.md)**
...
* Компонент **Генератор пустых полей**
